...
export function backendFailure(
	...
	details?: any,
	reference?: any
): Error & { backend: string; details?: any; reference?: any }
export function backendFailure(
	backend: string | any,
	details?: any,
	reference?: any
...
export namespace backendFailure {
	export function is(
		value: any
	): value is { status: 502; type: "backend failure"; backend: string; details?: any; reference?: any } {
		return (
			Error.is(value) &&
			value.status == 502 &&
			value.type == "backend failure" &&
			typeof (value as any).backend == "string"
		)
	}
}
